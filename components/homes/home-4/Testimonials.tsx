...
export default function Testimonials() {
  return (
    <section className="flat-spacing-2 section-testimonials bg_white pt-0">
        ...
        <div className="row">
          <div className="col-12">
            ...
            >
              ...
              <div className="sw-pagination-testimonial sw-dots type-circle d-xl-none d-flex justify-content-center spd19" />
            </Swiper>
          </div>
        </div>
      </div>
