...
import ColorOptions from "./ColorSelect";
import VariantPicker from "./SizeSelect";
import { useContextElement } from "@/context/Context";
import QuantitySelect from "../common/QuantitySelect";
import ColorOptions2 from "./ColorSelect6";
import VariantPicker2 from "./SizeSelect2";
interface Swatch {
  label: string;
  img: string;
  bgClass: string;
...
export default function Details13({ product }: ProductCardProps) {
                  ...
                  <div className="tf-product-info-choose-option gap-19">
                    ...
                    <div>
                      <div className="tf-product-info-by-btn mb_12">
                        <a
                          href="#"
                          className="tf-btn btn-onsurface flex-grow-1 btn-sold-out show-shopping-cart"
                        >
