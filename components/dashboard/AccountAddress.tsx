          ...
          <div className="my-account-content">
            <div className="account-address">
              <div className="text-center widget-inner-address">
                <button
                  className="tf-btn btn-onsurface mx-auto radius-4 mb_20 btn-address"
                  onClick={() =>
                    document
                ...
                >
                  ...
                  <div className="d-flex align-items-center justify-content-center gap-20">
                    ...
                    <span
                      className="tf-btn btn-onsurface radius-4 btn-outline justify-content-center btn-delete-address"
                      onClick={() =>
                        document
                          .querySelector(".createForm")
                  ...
                  {addresses.map((address) => (
                    <div className="account-address-item" key={address.id}>
                      ...
                      <div className="d-flex gap-10 justify-content-center">
                        <button
                          className="tf-btn radius-4 btn-onsurface justify-content-center btn-edit-address"
                      ...
                      {address.isEditing && (
                        ...
                        >
                          ...
                          <div className="d-flex flex-column gap-20">
                            <button
                              type="submit"
                              className="tf-btn w-full btn-onsurface radius-4"
                            >
                              <span className="text">Add address</span>
                            </button>
                            <span
                              onClick={() => handleEditToggle(address.id)}
                              className="tf-btn btn-onsurface w-full radius-4 btn-hide-edit-address"
                            >
                              <span className="text">Cancel</span>
                            </span>
                          </div>
